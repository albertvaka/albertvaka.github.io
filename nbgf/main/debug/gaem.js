...
// end include: /tmp/tmpi2g86vqk.js
...
var ASM_CONSTS = {
 ...
 631201: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 631284: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 631353: () => { return window.innerWidth; },  
 631383: () => { return window.innerHeight; }
};
