...
var ASM_CONSTS = {
 ...
 589942: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 590025: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 590094: () => { return window.innerWidth; },  
 590124: () => { return window.innerHeight; }
};
var wasmImports = {
  /** @export */
