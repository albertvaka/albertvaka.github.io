...
// end include: /tmp/tmp28_55xoe.js
...
var ASM_CONSTS = {
 ...
 590858: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 590941: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 591010: () => { return window.innerWidth; },  
 591040: () => { return window.innerHeight; }
};
